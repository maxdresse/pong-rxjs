...
import { PLAYER_BORDER_RADIUS, PLAYER_FONT_SIZE, PLAYER_PADDING_BOTTOM, PLAYER_PADDING_LEFT } from './ui-constants';
...
function initPlayerScoreUIElement(stl: CSSStyleDeclaration, textcol: string) {
    ...
    // padding is needed for perfect label centering
    stl.paddingBottom = PLAYER_PADDING_BOTTOM;
    stl.paddingLeft = PLAYER_PADDING_LEFT;
}
